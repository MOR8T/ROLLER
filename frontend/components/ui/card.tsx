...
export function CardHeader({ className, ...props }: CardHeaderProps) {
  return <div className={cn("border-b border-neutral-200 px-6 py-4", className)} {...props} />;
}
...
export function CardFooter({ className, ...props }: CardFooterProps) {
  return <div className={cn("border-t border-neutral-200 px-6 py-4", className)} {...props} />;
}
