# Graph Report - Praviz  (2026-07-23)

## Corpus Check
- 45 files · ~239,821 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 452 nodes · 681 edges · 30 communities (27 shown, 3 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a48917b7`
...
6. `Container()` - 11 edges
7. `RevealItem()` - 11 edges
8. `Section()` - 11 edges
9. `ROLLER colour palette` - 10 edges
10. `MediaFrame()` - 9 edges
...
Cohesion: 0.07
Nodes (32): WhatsAppFab(), Badge(), BadgeProps, BadgeVariant, BrandLogo(), BrandLogoProps, Button(), ButtonLink() (+24 more)
...
Cohesion: 0.08
Nodes (24): chakraPetch, metadata, montserrat, Footer(), InstagramIcon(), TelegramIcon(), WhatsAppIcon(), emptySubscribe() (+16 more)
...
Cohesion: 0.15
Nodes (12): ProductCardProps, Article, Category, Lead, Material, Partner, Product, ProductCardBadgeVariant (+4 more)

## Knowledge Gaps
- **190 isolated node(s):** `fallbackSlides`, `cityOptions`, `productTypes`, `trustPoints`, `semi` (+185 more)
...
- **Why does `siteConfig` connect `Hero and Product Cards` to `Site Shell Layout`, `Home Page Sections`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **What connects `fallbackSlides`, `cityOptions`, `productTypes` to the rest of the system?**
